 ...
 */
package com.fxiaoke.plugin.crm.stickycalendar;
...
import com.fxiaoke.plugin.crm.stickycalendar.adapter.CalendarAdapter;
import com.fxiaoke.plugin.crm.stickycalendar.adapter.MonthViewPagerAdapter;
import com.fxiaoke.plugin.crm.stickycalendar.adapter.WeekViewPagerAdapter;
...
import com.fxiaoke.plugin.crm.stickycalendar.view.MonthView;
import com.fxiaoke.plugin.crm.stickycalendar.view.WeekView;
...
//    TextView mCollapseTitle;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBtnCollapse = (TextView) findViewById(R.id.btn_container);
        mCalendarContainer = (ViewGroup) findViewById(R.id.calendar_container);
//        mBtnCollapse = (TextView) findViewById(R.id.btn);
...
//        mArrow = (ImageView) findViewById(R.id.arrow);
        ...
        btnBackToday.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mBtnCollapse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mMode == SpecialCalendar.CalendarType.MONTH) {
                    mBtnCollapse.setText("显示月视图");
//                    mArrow.setRotation(270);
                } else {
                    mBtnCollapse.setText("显示周视图");
                    ...
                    public void onAnimationUpdate(ValueAnimator animation) {
                        ...
                        if (mMode == SpecialCalendar.CalendarType.MONTH) {
                            ...
                            ViewGroup.MarginLayoutParams params =
                                    (ViewGroup.MarginLayoutParams) mListContainer.getLayoutParams();
